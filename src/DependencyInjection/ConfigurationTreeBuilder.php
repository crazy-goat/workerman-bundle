                ...
                ->prototype('array')
                    ...
                    ->children()
                        ...
                        ->booleanNode('serve_files')
                            ->info('Deprecated boolean switch enabling the legacy static file serving path configured by root_dir. Configure a StaticFilesMiddleware service instead.')
                            ->defaultFalse()
                            ...
                            ->end()
                        ->scalarNode('root_dir')
                            ->info('Deprecated path to the public directory served when the legacy serve_files switch is enabled. Configure a StaticFilesMiddleware service instead.')
                            ->setDeprecated('workerman', '0.9.3', 'Will be removed in 1.0. Use the StaticFilesMiddleware instead. See docs/security.md#static-files-protection. The static_files.allowed_extensions allowlist no longer applies once you move to the middleware; configure the $allowedExtensions constructor argument instead.')
                            ->defaultNull()
