                ...
                ->prototype('array')
                    ...
                    ->children()
                        ...
                        ->booleanNode('serve_files')
                            ...
                            ->defaultFalse()
                            ->setDeprecated('workerman', '0.9.3', 'Use static file middleware instead. See README.md middlewares section for details.')
                            ->end()
                        ->scalarNode('root_dir')
                            ->info('Should current worker serve files from public directory')
                            ->setDeprecated('workerman', '0.9.3', 'Use static file middleware instead. See README.md middlewares section for details.')
                        ...
                        ->arrayNode('static_files')
                            ...
                            ->setDeprecated('workerman', '0.9.3', 'Configure a StaticFilesMiddleware service with its $allowedExtensions constructor argument instead. See README.md middlewares section for details.')
                            ->addDefaultsIfNotSet()
                            ->children()
